"""
scripts/train.py — Main entry point for the SurvPFN survival analysis benchmark suite.

Usage:
    uv run python scripts/train.py
    uv run python scripts/train.py --tune --trials 20 --folds 5
"""
...
from survpfn.data.preprocessing import (
    clean_and_impute,
    prepare_cox_data,
...
from survpfn.models.classical import (
    run_univariate_cox,
    run_multivariate_cox,
    run_competing_risks_cox,
    run_kaplan_meier
)
from survpfn.eval.plotting import (
...
from survpfn.models.deep_hit import train_deephit_competing_risks
from survpfn.models.tree import train_rsf, train_gbsa
from survpfn.models.custom import train_custom_torchsurv
from survpfn.models.tabpfn.cox import train_embedding_cox
from survpfn.eval.metrics import evaluate_survival_model, run_statistical_tests
